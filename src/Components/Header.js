      ...
      <main>
        <div class="nav w3-bar w3-top">
          <div class="sub w3-cell">
            <div class="navbrand w3-col l1 m1 s1">
              <img
                class="logoMark"
            ...
            <a
              ...
              class="w3-right w3-hide-large  w3-cell-middle toggleMenu"
        ...
        <ul
          id="menuDrpdown"
          class="menuDrpdown  w3-hide w3-hide-large  w3-bar-block w3-top"
        >
          <li class="home menuLink" id="home">
            <a className="menuSmall">
              {" "}
              <NavLink
                exact
