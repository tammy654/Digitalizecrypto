...
function Home() {
  return (
    <>
      ...
      <div class="homepage-hero-section flex items-center">
        <div className="write-up w-[639px] px-5 md:pl-[100px] flex flex-col gap-10">
          ...
          <p className="uppercase text-3xl">
              <span className="marker bg-white p-1 font-semibold rounded-lg"> get</span> a lifetime on investments.
          </p>
      ...
      <div className="homepage-section-one sm:px-[100px]">
        <div className="sub flex flex-col md:flex-row gap-10 md:gap-20 py-14 px-3 md:rounded-2xl md:px-20 lg:gap-10 items-center">
          ...
          <div className="write-up right">
            ...
            <p className="details">
            At Digitalizecrypto, we believe the future is digital, and finance is no exception. We're a passionate team, dedicated to making cryptocurrency accessible and empowering for everyone. 
            Whether you're a seasoned investor or just starting your crypto journey, we offer a secure and user-friendly platform to buy, sell, and trade digital assets. 
            We're committed to providing top-notch customer support and educational resources to help you navigate the exciting world of crypto. 
            Join us and unlock the potential of digital finance with Digitalizecrypto.
            </p>
      ...
      <div className="homepage-section-three md:p-[100px] mb-8">
      ...
      <div className="homepage-section-two ">
        <div className="sub">
          <div className="headline flex justify-center gap-2 items-center px-3">
            <div class="line"></div>
            <h1 className="uppercase text-2xl font-bold text-center">Live Testimonials</h1>
            <div class="line"></div>
          </div>
